...
const HOTELS_DB: Record<string, Hotel[]> = {
  athens: [
    { name: "Hermes Hotel", area: "Syntagma", address: "Apollonos 19, Athens 105 57", pricePerNight: 142, currency: "EUR", rating: 8.9, stars: 3, metroStation: "Syntagma", metroDistance: "3 min", amenities: ["WiFi", "Breakfast", "A/C", "Rooftop bar"], highlights: "Acropolis views from rooftop, next to Plaka", lat: 37.9745, lng: 23.7345 },
    { name: "Hotel Plaka", area: "Plaka", address: "Kapnikareas 7, Athens 105 56", pricePerNight: 135, currency: "EUR", rating: 8.7, stars: 3, metroStation: "Monastiraki", metroDistance: "2 min", amenities: ["WiFi", "Breakfast", "Rooftop terrace"], highlights: "Heart of Plaka, rooftop with Acropolis view", lat: 37.9747, lng: 23.7260 },
    { name: "Athens Center Square", area: "Monastiraki", address: "Aristogeitonos 15, Athens 105 52", pricePerNight: 125, currency: "EUR", rating: 8.4, stars: 3, metroStation: "Monastiraki", metroDistance: "1 min", amenities: ["WiFi", "Breakfast", "Restaurant"], highlights: "On Monastiraki Square, ideal for exploring", lat: 37.9759, lng: 23.7251 },
    { name: "Electra Palace Athens", area: "Plaka", address: "Navarchou Nikodimou 18-20, Athens 105 57", pricePerNight: 195, currency: "EUR", rating: 9.1, stars: 5, metroStation: "Syntagma", metroDistance: "4 min", amenities: ["Pool", "Spa", "Rooftop restaurant", "WiFi", "Breakfast"], highlights: "Luxury option, rooftop pool with Acropolis view", lat: 37.9733, lng: 23.7330 },
    { name: "Fresh Hotel", area: "Omonia", address: "Sofokleous 26, Athens 105 52", pricePerNight: 105, currency: "EUR", rating: 8.2, stars: 4, metroStation: "Omonia", metroDistance: "2 min", amenities: ["Pool", "WiFi", "Restaurant", "Rooftop bar"], highlights: "Modern design hotel, rooftop pool, budget-friendly", lat: 37.9838, lng: 23.7275 },
  ],
  rome: [
    { name: "Hotel Raphael", area: "Navona", address: "Largo Febo 2, Roma 00186", pricePerNight: 210, currency: "EUR", rating: 9.0, stars: 5, metroStation: "Spagna", metroDistance: "10 min", amenities: ["WiFi", "Breakfast", "Rooftop terrace", "Spa"], highlights: "Iconic ivy-covered facade, rooftop with St Peter's view", lat: 41.8989, lng: 12.4710 },
    { name: "Hotel Lancelot", area: "Colosseum", address: "Via Capo d'Africa 47, Roma 00184", pricePerNight: 155, currency: "EUR", rating: 8.8, stars: 3, metroStation: "Colosseo", metroDistance: "3 min", amenities: ["WiFi", "Breakfast", "Garden", "A/C"], highlights: "Family-run, steps from the Colosseum", lat: 41.8876, lng: 12.4968 },
    { name: "Hotel Adriano", area: "Pantheon", address: "Via di Pallacorda 2, Roma 00186", pricePerNight: 175, currency: "EUR", rating: 8.6, stars: 4, metroStation: "Spagna", metroDistance: "8 min", amenities: ["WiFi", "Breakfast", "Bar", "A/C"], highlights: "Elegant boutique hotel near the Pantheon", lat: 41.9012, lng: 12.4765 },
    { name: "Roma Luxus Hotel", area: "Repubblica", address: "Via Velletri 39, Roma 00198", pricePerNight: 140, currency: "EUR", rating: 8.3, stars: 4, metroStation: "Repubblica", metroDistance: "2 min", amenities: ["WiFi", "Breakfast", "Fitness", "Restaurant"], highlights: "Modern luxury near Termini, great transport links", lat: 41.9095, lng: 12.4948 },
    { name: "Hotel Santa Maria", area: "Trastevere", address: "Vicolo del Piede 2, Roma 00153", pricePerNight: 165, currency: "EUR", rating: 8.9, stars: 3, metroStation: "Trastevere FS", metroDistance: "5 min", amenities: ["WiFi", "Breakfast", "Garden", "Bikes"], highlights: "Charming courtyard hotel in lively Trastevere", lat: 41.8893, lng: 12.4695 },
  ],
  santorini: [
    { name: "Cosmopolitan Suites", area: "Fira", address: "Fira 847 00, Santorini", pricePerNight: 250, currency: "EUR", rating: 9.2, stars: 4, metroStation: "Fira bus", metroDistance: "2 min", amenities: ["Pool", "WiFi", "Breakfast", "Caldera view"], highlights: "Infinity pool overlooking the caldera", lat: 36.4165, lng: 25.4315 },
    { name: "Katikies Hotel", area: "Oia", address: "Oia 847 02, Santorini", pricePerNight: 380, currency: "EUR", rating: 9.5, stars: 5, metroStation: "Oia bus", metroDistance: "3 min", amenities: ["Pool", "Spa", "WiFi", "Restaurant", "Butler"], highlights: "Iconic luxury cave hotel, famous sunset views", lat: 36.4617, lng: 25.3727 },
    { name: "Hotel Atlantis", area: "Fira", address: "Fira 847 00, Santorini", pricePerNight: 180, currency: "EUR", rating: 8.4, stars: 3, metroStation: "Fira bus", metroDistance: "1 min", amenities: ["WiFi", "Breakfast", "Pool", "A/C"], highlights: "Central location, caldera views at mid-range price", lat: 36.4170, lng: 25.4308 },
    { name: "Astra Suites", area: "Imerovigli", address: "Imerovigli 847 00, Santorini", pricePerNight: 310, currency: "EUR", rating: 9.3, stars: 5, metroStation: "Imerovigli bus", metroDistance: "2 min", amenities: ["Pool", "Spa", "WiFi", "Breakfast", "Gym"], highlights: "Highest point on caldera, stunning panoramic views", lat: 36.4320, lng: 25.4222 },
    { name: "Santorini Palace", area: "Fira", address: "Fira 847 00, Santorini", pricePerNight: 150, currency: "EUR", rating: 8.1, stars: 3, metroStation: "Fira bus", metroDistance: "4 min", amenities: ["Pool", "WiFi", "A/C", "Restaurant"], highlights: "Good value with pool, close to nightlife", lat: 36.4158, lng: 25.4332 },
  ],
  paris: [
